...
select c.Nome, f.nome Unidade, SUBSTRING(CONVERT(VARCHAR(10), a.data, 103), 4, 7) COMP, d.CodigoSus,  d.Descricao,SUM(a.QTDE) TOTAL 
...
and a.data between '2017-06-01 00:00:00.000'and'2017-06-12 23:59:00.000'
